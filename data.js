...
var QUESTION_BANK = {
  "unitCatalog": [
    ...
    },
    {
      ...
      "book": "Here We Go 4 (四下)",
      "unit": "Unit 2",
      "title": "Unit 2 What Are You Doing?",
      "count": 26,
      "hasPhonics": true,
      "questions": [
        {
    ...
    },
    {
      ...
      "book": "Here We Go 6 (五下)",
      "unit": "Unit 2",
      "title": "Unit 2 Do You Have a Headache?",
      "count": 32,
      "hasPhonics": true,
      "questions": [
        {
    ...
    },
    {
      ...
      "book": "Here We Go 7 (六上)",
      "unit": "Unit 2",
      "title": "Unit 2 How Do You Go to School?",
      "count": 15,
      "hasPhonics": true,
      "questions": [
        {
    ...
    },
    {
      ...
      "questions": [
        ...
        {
          "type": "vocab",
          "en": "at the movie theater",
          "zh": "在電影院",
          "options": [
            "在餐廳|at the restaurant",
            "在動物園|at the zoo",
            "在電影院|at the movie theater",
            "是(am/is 的過去式)|was"
          ],
      ...
      "questions": [
        {
          ...
          "zh": "打掃我的房間(過去式)",
          "options": [
            "聽音樂(過去式)|listened to music",
            "上一次；最後|last",
            "打掃我的房間(過去式)|cleaned my room",
            "做(do 的過去式)|did"
          ],
          "book": "Here We Go 8 (六下)",
          "unit": "Unit 2"
        },
        {
          ...
          "options": [
            "聽音樂(過去式)|listened to music",
            "打籃球(過去式)|played basketball",
            "遛狗(過去式)|walked the dog",
            "拜訪朋友(過去式)|visited a friend"
          ],
          "book": "Here We Go 8 (六下)",
          "unit": "Unit 2"
        },
...
var grade3Data = QUESTION_BANK.allByGrade["3"];
var grade4Data = QUESTION_BANK.allByGrade["4"];
var grade5Data = QUESTION_BANK.allByGrade["5"];
var grade6Data = QUESTION_BANK.allByGrade["6"];

if (typeof window !== "undefined") {
  window.QUESTION_BANK = QUESTION_BANK;
  window.grade3Data = grade3Data;
  window.grade4Data = grade4Data;
  window.grade5Data = grade5Data;
  window.grade6Data = grade6Data;
}
if (typeof module !== "undefined" && module.exports) {
  module.exports = { QUESTION_BANK, grade3Data, grade4Data, grade5Data, grade6Data };
}
